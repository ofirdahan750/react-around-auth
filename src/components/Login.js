...
const Login = ({
  ...
  return (
    <div className="popup-box_type_auth">
      ...
      >
        ...
        <span className="popup-box__bottom-link link-modifier animation-modifier_type_opacity-hover">
          <Link to="/signup"> {formSetting.bottomLinkTxt || "loading..."}</Link>
        </span>
      </form>
    </div>
  );
